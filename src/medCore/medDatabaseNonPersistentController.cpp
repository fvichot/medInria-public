...
dtkSmartPointer<dtkAbstractData> medDatabaseNonPersistentController::read( const medDataIndex& index ) const
{
...
void medDatabaseNonPersistentController::import(dtkAbstractData *data,
                                                    QString callerUuid)
{
