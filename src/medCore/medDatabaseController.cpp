...
void medDatabaseController::import( dtkAbstractData *data, QString importUuid)
{    
...
void medDatabaseController::exportDataToFile(dtkAbstractData *data, const QString & filename, const QString & writer)
{
...
dtkSmartPointer<dtkAbstractData> medDatabaseController::read(const medDataIndex& index) const
{
